...
namespace GANN
{
    class GANN
    {
        ...
        public GANN(double[][] trainInput, double[][] trainOutput, double[][] testInput, double[][] testOutput, Random random = null)
        {
            ...
            HypereparametersRange.GradStratDist = new SetRange<GradientStepStrategy>(new GradientStepStrategy[] { new ConstantGradientStep(0.01), new ConstantGradientStep(1), new ConstantGradientStep(0.001) }, new UniformDiscreteRangeDistribution(random, 0, 3));
